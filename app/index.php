...
echo <<<ZZEOF
                    ...
                    <div class="fab-box">
                <li class="red-fab">
                    <svg version="1.2" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px" width="2em" height="2em" viewBox="-0.8 -0.5 177 202" xml:space="preserve">
                        <defs>
                        </defs>
                ...
                <li class="dark-fab">Add a recipe</li>
            </div>
                    </div>                    
ZZEOF;
                } else {
